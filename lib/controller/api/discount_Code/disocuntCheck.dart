...
Future<ApiResult> discountCheck({
  required BuildContext context,
  String? code,
}) async {
  final api = Tikonline.create(interceptors: [TokenInterceptor('accessToken')]);

  final postResult = await api.apiV1PaymentCheckDiscountGet(code: code);
  print(postResult);
  ...
  context
      .read<DiscountCheckState>()
      .getDiscountMassage(value: response.message!);
