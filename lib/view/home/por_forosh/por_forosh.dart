...
class PorForoshScreen extends StatefulWidget {
  final List<BookDto> bookDto;
  const PorForoshScreen({super.key, required this.bookDto});

  @override
  State<PorForoshScreen> createState() => _PorForoshScreenState();
}

class _PorForoshScreenState extends State<PorForoshScreen> {
              ...
              child: Directionality(
                ...
                child: SizedBox(
                  ...
                  child: GridView.builder(
                    ...
                    itemCount: widget.bookDto.length,
                    ...
                    itemBuilder: (context, index) => Padding(
                      ...
                      child: BookCardWidget(
                        discountCount:
                            "${((widget.bookDto[index].price! - widget.bookDto[index].totalPrice!) / widget.bookDto[index].price! * 100).toStringAsFixed(0)}",
                        discountPrice:
                            widget.bookDto[index].totalPrice.toString(),
                        viewCont: widget.bookDto[index].viewCount!,
                        bookId: widget.bookDto[index].id.toString(),
                        bookWriter: widget.bookDto[index].nevisande.toString(),
                        bookRate: widget.bookDto[index].rating!.toDouble(),
                        bookPrice: widget.bookDto[index].price.toString(),
                        bookName: widget.bookDto[index].title.toString(),
                        bookImage: widget.bookDto[index].imageUrl.toString(),
                      ),
                    ),
                  ),
                ),
